...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-6">
            ...
            <!-- Cards Section -->
            <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-[100px]">
                <!-- Total Donations Card -->
                <div class="bg-yellow-500 p-6 rounded-lg shadow-lg flex items-center justify-between">
                    <div>
                        <h3 class="text-xl font-semibold text-white">Total Donations</h3>
                        <p class="text-2xl text-white font-bold">${{ number_format($totalDonations, 2) }}</p>
                    </div>
                ...
                <!-- Number of Donations Card -->
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex items-center justify-between">
                    <div>
                        <h3 class="text-xl font-semibold text-gray-100">Number of Donations</h3>
                        <p class="text-2xl text-yellow-600 font-bold">{{ $numberOfDonations }}</p>
                    </div>
                    <div class="bg-white p-4 rounded-full">
                        <i class="fas fa-hand-holding-heart text-4xl text-yellow-600"></i>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg flex items-center justify-between">
                    <div>
                        <h3 class="text-xl font-semibold text-gray-700">Total Registered Donors</h3>
                        <p class="text-2xl text-blue-600 font-bold">{{ $totalDonors }}</p>
                    </div>
